    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{ route('discountcode.create') }}" class="btn btn-primary">New Coupon Code Create</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="card-title">
                    <a href="{{ route('discountcode.index') }}" class="btn btn-default btn-sm">Reset</a>
                </div>
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> @if ($discountCoupon->type == 'percent')
                            ...
                            <td>
                                <a href="{{ route('discountcode.edit',$discountCoupon->id) }}">
                                    <svg class="filament-link-icon w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                        <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
                                    </svg>
                                </a>
                                <form action="{{ route('discountcode.destroy', $discountCoupon->id) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
