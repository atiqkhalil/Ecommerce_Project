            ...
            <div class="tabs-header d-flex justify-content-between border-bottom my-5">
              ...
              <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  ...
                  <a href="{{ route('front.shop', 'fruits-veges') }}" class="nav-link text-uppercase fs-6" id="nav-fruits-tab" data-bs-toggle="tab" data-bs-target="#nav-fruits">Fruits & Veges</a>
                    ...
                    <div id="product-page">
                      <div class="product-item">
                        <form action="{{ route('wishlist', $product->id) }}" method="POST" class="d-inline">
                          ...
                          {{-- <a href="{{ route('wishlist',$product->id) }}" class="btn-wishlist">
                              <svg width="24" height="24">
                                  <use xlink:href="#heart"></use>
                              </svg>
                          </a> --}}
